...
def test_check_incorrect_username():
    ...
    driver = webdriver.Chrome(
        service=Service(r"C:\\Users\\38063\\GorQAuto\\" + "chromedriver.exe")
        )
    ...
    # Знаходимо поле, в яке будемо вводити неправильни пароль
    ...
    # Перевіряємо, що назвасторінки така, яку ми очікуємо
